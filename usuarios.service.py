        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if rtaSistema.status_code == 200:
                    ...
                    respuestaFinal.usuariosNotificaciones = Usuarios
                    respuestaFinal.db.certificados = Certificados
                    respuestaFinal.db.vacunacion = Vacunas
                    respuestaFinal.db.mascotas = Mascotas

        except Exception as e:
            respuestaFinal.error = str(e) + " - linea: " + str(sys.exc_info()[-1].tb_lineno)

        self.response.payload = respuestaFinal.toJSON()
